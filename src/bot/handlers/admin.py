...
COMMAND_HELP = {
    ...
    "delbefore": (
        ...
        "• 回复某条消息：/delbefore &lt;数量&gt;\n\n"
        "<b>使用示例：</b>\n"
        "• /delbefore 10 - 删除往前10条\n"
        "• /delbefore 50 - 删除往前50条\n\n"
        "<b>限制：</b>\n"
        "• 最多一次删除 100 条\n"
        "• 只能删除48小时内的消息\n"
        "• 需要回复某条消息\n\n"
    ...
    "delrange": (
        ...
        "<b>使用方法：</b>\n"
        "• /delrange &lt;起始ID&gt; &lt;结束ID&gt;\n"
        "• /delrange &lt;消息链接1&gt; &lt;消息链接2&gt;\n\n"
        "<b>使用示例：</b>\n"
        "• /delrange 1000 1050\n"
        "• /delrange https://t.me/c/xxx/100 https://t.me/c/xxx/200\n\n"
        "<b>限制：</b>\n"
        "• 最多一次删除 100 条\n"
        "• 只能删除48小时内的消息\n\n"
        "<b>权限要求：</b>群组管理员"
    ...
    "approve": (
        ...
        "批准或拒绝垃圾消息举报。\n\n"
        "<b>使用方法：</b>\n"
        "• /approve &lt;举报ID&gt; approve - 批准\n"
        "• /approve &lt;举报ID&gt; reject - 拒绝\n\n"
        "<b>使用示例：</b>\n"
        "• /approve 123 approve\n"
        "• /approve 456 reject\n\n"
        "<b>处理结果：</b>\n"
