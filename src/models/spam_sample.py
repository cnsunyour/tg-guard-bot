...
class SpamSample(Base):
    ...
    confidence: Mapped[float | None] = mapped_column(Float, nullable=True, comment="置信度分数")
    labeled_by: Mapped[int | None] = mapped_column(BigInteger, nullable=True, comment="标注者 ID")
