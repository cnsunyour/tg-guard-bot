...
-- 群组消息语言字段
ALTER TABLE groups ADD COLUMN IF NOT EXISTS locale VARCHAR(16) NOT NULL DEFAULT 'zh-CN';
COMMENT ON COLUMN groups.locale IS '群组消息语言（BCP 47，如 zh-CN/zh-TW/zh-HK/en）';
